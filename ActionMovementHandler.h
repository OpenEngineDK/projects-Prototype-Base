...
#ifndef _ACTION_MOVEMENT_HANDLER_H_
#define _ACTION_MOVEMENT_HANDLER_H_
...
namespace OpenEngine {
	namespace Utils {
		...
		*/
		class ActionMovementHandler : public IModule {
		...
		public:
            ...
            ActionMovementHandler(Tank* tank, IMouse* m, FixedTimeStepPhysics* physics, int midX = 300, int midY = 300);
			~ActionMovementHandler();
			void Initialize();
			void Deinitialize();
